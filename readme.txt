...
1. Upload the plugin files to the `/wp-content/plugins/math-input-mathquill` directory, or install the plugin through the WordPress plugins screen directly.
